...
router.post('/forgot-password', async (req, res) => {
  try {
    ...
    const content = `
      ...
      <p style="color: #ef4444; font-size: 14px; margin-top: 15px;">⚠️ This link expires in 15 minutes.</p>
      <p style="font-size: 12px; margin-top: 10px;">If you did not request this, please ignore this email.</p>
    `;

    const html = getBaseTemplate("Password Reset Request", content, resetLink, "Reset Password");
